...
def load_model(properties):
    ...
    logging.info(f"Loading model from hf: {model_location}")
    ...
    if "load_4bit" in properties:
        load_4bit_flag = properties["load_4bit"]
    else:
        load_4bit_flag = True
    ...
    tokenizer, model, image_processor, context_len = load_pretrained_model(
        model_location, model_base=None, model_name="llava", load_4bit=load_4bit_flag)
